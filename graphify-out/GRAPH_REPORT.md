# Graph Report - optic  (2026-07-17)

## Corpus Check
- 163 files · ~788,053 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 909 nodes · 1146 edges · 81 communities (67 shown, 14 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `138d7232`
...
7. `/graphify` - 10 edges
8. `Feature: Giỏ hàng (Cart) — SPECIFICATION` - 10 edges
9. `UserController` - 9 edges
...
- `ShippingForm()` --calls--> `useCheckoutStore`  [EXTRACTED]
  src/frontend/src/feature/checkout/components/ShippingForm.jsx → src/frontend/src/feature/checkout/store/useCheckoutStore.js
...
- `UserManagePage()` --calls--> `useAdminUsers()`  [EXTRACTED]
  src/frontend/src/feature/admin/page/UserManagePage.jsx → src/frontend/src/feature/admin/hooks/useAdminUsers.js
...
Cohesion: 0.13
Nodes (10): DashboardController, ADR-0003, PaymentController, ADR-0003, OrderSchema, ProductVariantSchema, VariantImageSchema, pickPrice() (+2 more)

### Community 2 - "dependencies"
Cohesion: 0.05
Nodes (37): bcrypt, bcryptjs, cors, dotenv, express, google-auth-library, joi, jsonwebtoken (+29 more)

### Community 3 - "MyOrder.jsx"
Cohesion: 0.06
Nodes (23): ShippingForm(), VnpayCheckoutButton(), useCheckoutVnpay(), policyApi, refundApi, ProductFeedback(), profileApi, orderApi (+15 more)

### Community 4 - "index.js"
Cohesion: 0.23
Nodes (11): authenticate(), requireRole(), router, router, router, router, upload, router (+3 more)
...
Cohesion: 0.07
Nodes (29): axios, framer-motion, @hookform/resolvers, lucide-react, react, react-dom, react-helmet-async, react-hook-form (+21 more)

### Community 7 - "useCartStore"
Cohesion: 0.12
Nodes (21): paymentApi, CheckoutStepper(), OrderSummary(), PaymentForm(), ReviewOrder(), useOrderSuccess(), usePaymentRequirement(), useCheckoutFlow() (+13 more)

### Community 8 - "User"
Cohesion: 0.08
Nodes (11): AuthController, googleLoginSchema, loginSchema, registerSchema, resendEmailSchema, UserController, User, userSchema (+3 more)

### Community 9 - "devDependencies"
Cohesion: 0.08
Nodes (23): autoprefixer, postcss, devDependencies, autoprefixer, postcss, tailwindcss, @types/react, @types/react-dom (+15 more)

### Community 10 - "Product.js"
Cohesion: 0.14
Nodes (7): ProductController, ImageSchema, ProductSchema, __dirname, __filename, filterRawItemToSchema(), seedProducts()
...
Cohesion: 0.14
Nodes (5): ADR-0003, RefundController, OrderItemSchema, PrescriptionSchema, RefundSchema
...
Cohesion: 0.18
Nodes (10): 1. Business Context, 2. User Stories, 3. Acceptance Criteria (EARS), 4.1 Lấy danh sách sản phẩm, 4.2 Thêm sản phẩm mới (dành cho MANAGER/ADMIN), 4.3 Biến thể sản phẩm (Product Variants sub-routes), 4. API Contract, 5. Technical Constraints (+2 more)
...
## Knowledge Gaps
- **433 isolated node(s):** `registerSchema`, `loginSchema`, `googleLoginSchema`, `resendEmailSchema`, `ADR-0003` (+428 more)
