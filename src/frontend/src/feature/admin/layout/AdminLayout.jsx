    ...
    <div className="flex h-screen bg-zinc-50 font-sans">
      ...
      >
        ...
        <button
          ...
          className="hidden md:flex absolute -right-3.5 top-10 bg-white text-zinc-900 w-7 h-7 items-center justify-center rounded-full shadow-lg hover:bg-rose-500 hover:text-white transition-all z-30"
        >
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-white">
        <header className="h-16 md:h-20 border-b border-zinc-100 flex items-center justify-between px-4 md:px-10 gap-3">
          ...
          <button
            ...
            className="md:hidden p-2 -ml-2 text-zinc-700 hover:text-rose-600 transition-colors shrink-0"
            aria-label="Mở menu"
          >
