...
*   **Phân vai (Role):** 4 phân vai chính của hệ thống:
    ...
    - `SALE`: Nhân viên bán hàng & đóng gói đơn.
...
*   **Người chịu tác động:** Sale, Manager, Customer (Bị kiểm soát hoạt động trên hệ thống).
...
*   *Q1:* Có cần lưu giữ lịch sử nhật ký (Log) của Admin khi thực hiện đổi vai hoặc khóa tài khoản của người khác để dễ dàng tra cứu hay không? (Hiện tại: Chưa triển khai ghi Log admin).
