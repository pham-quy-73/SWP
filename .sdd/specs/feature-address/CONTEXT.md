...
*   *Q1:* Có cần khống chế số lượng địa chỉ tối đa mà một người dùng có thể lưu trữ trong sổ địa chỉ (ví dụ: tối đa 10 địa chỉ) không? (Hiện tại: không giới hạn).
*   *Q2:* Có cần tích hợp dịch vụ xác thực số điện thoại người nhận khi lưu địa chỉ không? (Hiện tại: chỉ validate định dạng SĐT).
