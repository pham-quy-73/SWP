...
- _Q1:_ Có cần áp dụng cơ chế tự động hạ bộ lọc sang trạng thái ẩn (ngừng bán) nếu toàn bộ biến thể của sản phẩm chính đều có số lượng bằng 0 hay không? (Hiện tại: Vẫn cho hiển thị nhưng báo Hết hàng).
